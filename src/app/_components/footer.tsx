...
const [showButton, setShowButton] = useState(false);
  ...
  useEffect(() => {
    ...
    return(
        <section id="footer" className='py-16 text-gray-400 relative overflow-hidden'>
            <div className='container mx-auto px-4'>
                <footer className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md-12 mt-5'>
                    <div data-aos="fade-right" data-aos-delay="300">
                        ...
                        <a href={`https://wa.me/5585991649714?text=Ola vim pelo site e gostaria de mais informações sobre consultas`} target='_blank' className='bg-emerald-600 hover:bg-emerald-700 text-white px-4 py-2 mt-4 rounded-md font-semibold flex items-center w-fit gap-2'>
                    ...
                    <div data-aos="fade-left" data-aos-delay="300">
                        ...
                        <div className='flex gap-4'>
                            ...
                            <a href="https://www.instagram.com/centrodesaudemessejana/" target='_blank' className='w-10 h-10' style={{ fontSize: 25 }}>
                                <InstagramLogo/>
                            </a>
                    ...
                    {showButton && (
                        <a href={`https://wa.me/5585991649714?text=Ola vim pelo site e gostaria de mais informações.`} target='_blank' className="fixed bottom-6 right-6 bg-emerald-600 hover:bg-emerald-700 text-white w-12 h-12 rounded-full flex items-center justify-center shadow-lg transition-all duration-300 z-50">
